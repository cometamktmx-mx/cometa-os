...
export async function PATCH(request: Request) {
  try {
    ...
    const { data: current } = await access.admin.from("comu_storefronts").select("theme_config").eq("seller_id", sellerId).maybeSingle();
